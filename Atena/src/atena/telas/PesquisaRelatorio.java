...
import atena.util.FormataTamanhoColunasJTable;
 ...
 * @author Karlos
 */
public class PesquisaRelatorio extends javax.swing.JDialog {

    private static Object objeto;

    public static Object exibeTela(AbstractTableModel atm, String pesquisa) {
        PesquisaRelatorio tp = new PesquisaRelatorio(atm, pesquisa);
        tp.setVisible(true);
        return objeto;

    }

    private PesquisaRelatorio(AbstractTableModel atm, String pesquisa) {
        initComponents();
    ...
    public PesquisaRelatorio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaRelatorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaRelatorio dialog = new PesquisaRelatorio(new javax.swing.JFrame(), true);
